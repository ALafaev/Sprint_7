...
class TestCreateCourier:
    ...
    def test_courier_creation_with_valid_data_return_201_created(self, delete_courier):
        ...
        assert response.status_code == 201 and response.json() == ResponseText.CREATE_COURIER_SUCCESSFULLY, "Ответ сервера не совпадает с ожидаемым"
    ...
    def test_courier_creation_with_the_same_data_return_409_conflict(self):
        ...
        assert response.status_code == 409 and response.json() == ResponseText.CREATE_COURIER_LOGIN_ALREADY_USED, "Ответ сервера не совпадает с ожидаемым"
    ...
    def test_courier_creation_without_login_value_return_400_bad_request(self):
        ...
        assert response.status_code == 400 and response.json() == ResponseText.CREATE_COURIER_NOT_ENOUGH_DATA, "Ответ сервера не совпадает с ожидаемым"
