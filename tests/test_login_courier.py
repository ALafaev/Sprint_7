...
class TestLoginCourier:
    ...
    def test_courier_login_with_valid_data_return_200_ok(self):
        ...
        assert response.status_code == 200 and ResponseText.LOGIN_COURIER_SUCCESSFULLY_CONTAINS in response.json(), "Ответ сервера не совпадает с ожидаемым"
    ...
    def test_courier_login_without_login_return_400_bad_request(self):
        ...
        assert response.status_code == 400 and response.json() == ResponseText.LOGIN_COURIER_NOT_ENOUGH_DATA, "Ответ сервера не совпадает с ожидаемым"
    ...
    def test_courier_login_with_wrong_password_return_404_not_found(self):
        ...
        assert response.status_code == 404 and response.json() == ResponseText.LOGIN_COURIER_ACCOUNT_NOT_FOUND, "Ответ сервера не совпадает с ожидаемым"
